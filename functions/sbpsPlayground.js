export default function sbpsPlayground(ending) {
  if (ending === "BASKETBALL COURT") {
    return [
      { latitude: 23.35455, longitude: 85.4134 },
      { latitude: 23.35453, longitude: 85.41325 },
      { latitude: 23.354, longitude: 85.41333 },
    ...
    return [
      ...
      { latitude: 23.3501, longitude: 85.4132 },
      { latitude: 23.3501, longitude: 85.4133 },
      { latitude: 23.35015, longitude: 85.41447 },
